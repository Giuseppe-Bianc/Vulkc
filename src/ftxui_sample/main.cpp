...
// configuration step. It creates a namespace called `Vulkc`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Vulkc::cmake::project_name, Vulkc::cmake::project_version) };
